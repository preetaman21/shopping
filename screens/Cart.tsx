  ...
  return (
    <View>
      <View className="flex flex-row">
        ...
        <View className="">
          ...
          <View className="m-4 flex flex-row">
            <Text className="bg-pink-900 p-2 font-bold text-white rounded-xl">Size: free</Text>
            <Text className="bg-pink-900 p-2 font-bold text-white rounded-xl ml-4">Qty:1</Text>
          </View>
      ...
      <View className="flex flex-row justify-evenly mt-4 bg-gray-200 p-2">
        <View className="flex flex-row">
          <Ionicons name={'heart-outline'} size={24} color="#70184A"/>
          <Text>Add To Wishlist</Text>
        </View>
        <View className="flex flex-row">
          <Entypo name="cross" size={24} color="#70184A" />
